...
function endPage() {
    ...
    function onloadResp(rep_y) {
        ...
        if (document.getElementById("sel").value == "" || document.getElementById("sel").value == null) {
        ...
        if (gOrder != "") {
            ...
            //alert(placedOrder.DelivaryDate);
...
function getRegistration() {
        var elem = document.getElementById("RegisterId");
        elem.style.display = "block";
        var hideelem1 = document.getElementById("newUser");
        hideelem1.style.display = "none";
        var hideElem2 = document.getElementById("loginId");
